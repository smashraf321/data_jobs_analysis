...
1. Open pgAdmin
2. In Object Explorer (left-hand pane), navigate to `data_jobs` database
3. Right-click `data_jobs` and select `PSQL Tool`
...
\copy skills_job_dim FROM '[your file path]\data_jobs_analysis\csv_files\skills_job_dim.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
